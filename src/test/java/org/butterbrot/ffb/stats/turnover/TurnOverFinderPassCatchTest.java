...
public class TurnOverFinderPassCatchTest extends AbstractTurnOverFinderTest {
	...
	public void failedPassFumble() {
		...
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer, 1, 3, true, false, PassResult.FUMBLE));
	...
	public void failedPassFumbleCatchByOpponent() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer, 1, 3, false, false, PassResult.FUMBLE));
		turnOverFinder.add(new ReportScatterBall());
	...
	public void failedPassFumbleSkillReRoll() {
		...
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer, 1, 3, false, true, PassResult.FUMBLE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
		assertTrue("Fumbled pass is a turnover", turnOverOpt.isPresent());
	...
	public void failedPassFumbleSafeThrow() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  2, 3, false, false, PassResult.SAVED_FUMBLE));
	...
	public void failedPassFumbleSafeThrowFails() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  2, 3,  false, false, PassResult.FUMBLE));
	...
	public void failedPassMissedThrow() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  2, 3,  false, false, PassResult.INACCURATE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportScatterBall());
	...
	public void successPassEmpty() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer, 3, 3,  false, false, PassResult.ACCURATE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
	...
	public void failedPassMissedThrowSkillReRoll() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  1, 3, false, false, PassResult.INACCURATE));
		turnOverFinder.add(new ReportReRoll(actingPlayer, ReRollSources.PASS, true, 6));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  2, 3,  false, true, PassResult.INACCURATE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
	...
	public void successPass() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer, 4, 3,  false, false, PassResult.ACCURATE));
	...
	public void failedPassFumbleFromDumpOff() {
		...
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(opponent, 1, 3,  false, false, PassResult.FUMBLE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
	...
	public void interceptionCancelledWithReroll() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(new ReportInterceptionRoll(opponent, true, 6, 6, false, null, false));
		turnOverFinder.add(new ReportSafeThrowRoll(actingPlayer, false, 2, 3, false, new RollModifier[0]));
		turnOverFinder.add(new ReportReRoll(opponent, ReRollSources.TEAM_RE_ROLL, true, 6));
		turnOverFinder.add(new ReportSafeThrowRoll(actingPlayer, true, 4, 3, true, new RollModifier[0]));
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
	...
	public void hailMary() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.hailMaryPass(actingPlayer, 2, false, false, PassResult.INACCURATE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
	...
	public void hailMaryReRolled() {
		turnOverFinder.add(new ReportPlayerAction(actingPlayer, PlayerAction.PASS));
		turnOverFinder.add(AbstractTurnOverFinderTest.hailMaryPass(actingPlayer, 1, false, false, PassResult.FUMBLE));
		turnOverFinder.add(new ReportReRoll());
		turnOverFinder.add(AbstractTurnOverFinderTest.hailMaryPass(actingPlayer, 2, false, true, PassResult.INACCURATE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
		assertTrue("Uncaught hail mary pass is a turnover", turnOverOpt.isPresent());
	...
	public void hailMaryFumbleSkillReRoll() {
		...
		turnOverFinder.add(AbstractTurnOverFinderTest.hailMaryPass(actingPlayer, 1, false, false, PassResult.FUMBLE));
		turnOverFinder.add(new ReportReRoll(actingPlayer, ReRollSources.PASS, true, 6));
		turnOverFinder.add(AbstractTurnOverFinderTest.hailMaryPass(actingPlayer,  1, false, true, PassResult.FUMBLE));
		turnOverFinder.add(new ReportScatterBall());
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
		assertTrue("Fumbled pass is a turnover", turnOverOpt.isPresent());
	...
	public void bombOpponentOnlyDown() {
		...
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer, 4, 3,  true, false, PassResult.ACCURATE));
	...
	public void bombFumbleReRoll() {
		...
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  1, 3,  true, false, PassResult.FUMBLE));
		turnOverFinder.add(new ReportReRoll(actingPlayer, ReRollSources.TEAM_RE_ROLL, true, 6));
		turnOverFinder.add(AbstractTurnOverFinderTest.regularPass(actingPlayer,  1, 3, true, true, PassResult.FUMBLE));
		turnOverFinder.add(new ReportInjury(teamMember, null, false, null, null, null, null, null, null, null, null, null, null, null));
		turnOverFinder.add(new ReportTurnEnd(null, null, null, new ArrayList<>()));
		Optional<TurnOver> turnOverOpt = turnOverFinder.findTurnover();
		assertTrue("Fumbled pass is a turnover", turnOverOpt.isPresent());
