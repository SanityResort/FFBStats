 ...
 */
package refactored.com.balancedbytes.games.ffb.util;
...
public class ArrayTool {
    ...
    public static int total(int[] pArray) {
        int total = 0;
        if (ArrayTool.isProvided(pArray)) {
    ...
    public static boolean isEqual(Object[] pArray1, Object[] pArray2) {
        ...
        if (ArrayTool.isProvided(pArray1) && ArrayTool.isProvided(pArray2)) {
            isEqual = pArray1.length == pArray2.length;
            for (int i = 0; isEqual && i < pArray1.length; ++i) {
                isEqual = pArray1[i].equals(pArray2[i]);
            }
        } else {
            isEqual = !ArrayTool.isProvided(pArray1) && !ArrayTool.isProvided(pArray2);
        }
        return isEqual;
    }
