...
public class ReportSpecialEffectRoll implements IReport {
    ...
    public ReportSpecialEffectRoll(SpecialEffect pSpecialEffect, String pPlayerId, boolean pSuccessful, int pRoll) {
    ...
    public IReport transform() {
        return new ReportSpecialEffectRoll(this.getSpecialEffect(), this.getPlayerId(), this.isSuccessful(), this.getRoll());
    }
