...
implements IDialogCloseListener {
    ...
    private boolean checkVersion(String pServerVersion, String pClientVersion) {
        if (this.checkVersionConflict(pClientVersion, "1.2.5")) {
            String[] messages = new String[]{"Server expects client version " + pClientVersion + " or newer.", "Client version is 1.2.5.", "Please update your client!"};
        ...
        if (this.checkVersionConflict("1.2.5", pServerVersion)) {
            String[] messages = new String[]{"Client expects server version 1.2.5 or newer.", "Server version is " + pServerVersion + ".", "Please wait for a server update!"};
