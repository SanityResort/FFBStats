...
public interface IClientProperty {
    ...
    public static final String CLIENT_COMMAND_COMPRESSION = "client.command.compression";
    public static final String SETTING_SOUND_MODE = "setting.sound.mode";
    public static final String SETTING_SOUND_VOLUME = "setting.sound.volume";
    public static final String SETTING_ICONS = "setting.icons";
    public static final String SETTING_CHATLOG = "setting.chatlog";
    public static final String SETTING_AUTOMOVE = "setting.automove";
    public static final String SETTING_PITCH_CUSTOMIZATION = "setting.pitch.customization";
    public static final String SETTING_PITCH_MARKINGS = "setting.pitch.markings";
    public static final String SETTING_TEAM_LOGOS = "setting.pitch.teamLogos";
    public static final String SETTING_PITCH_WEATHER = "setting.pitch.weather";
    public static final String SETTING_RANGEGRID = "setting.rangegrid";
    public static final String CLIENT_PING_INTERVAL = "client.ping.interval";
    public static final String CLIENT_PING_MAX_DELAY = "client.ping.maxDelay";
    public static final String CLIENT_DEBUG_STATE = "client.debug.state";
    ...
    public static final String KEY_PLAYER_ACTION_LEAP = "key.player.action.leap";
