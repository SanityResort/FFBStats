...
public interface IClientPropertyValue {
    ...
    public static final String SETTING_CHATLOG_EXTRA_CHAT = "extraChat";
    public static final String SETTING_CHATLOG_INTEGRATED_CHAT = "integratedChat";
    ...
    public static final String SETTING_RANGEGRID_TOGGLE = "rangegridToggle";
}
