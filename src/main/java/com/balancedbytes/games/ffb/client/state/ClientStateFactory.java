...
import com.balancedbytes.games.ffb.client.state.ClientStateBlitz;
import com.balancedbytes.games.ffb.client.state.ClientStateBlock;
import com.balancedbytes.games.ffb.client.state.ClientStateBomb;
import com.balancedbytes.games.ffb.client.state.ClientStateDumpOff;
import com.balancedbytes.games.ffb.client.state.ClientStateFoul;
import com.balancedbytes.games.ffb.client.state.ClientStateGaze;
import com.balancedbytes.games.ffb.client.state.ClientStateHandOver;
import com.balancedbytes.games.ffb.client.state.ClientStateHighKick;
import com.balancedbytes.games.ffb.client.state.ClientStateIllegalSubstitution;
import com.balancedbytes.games.ffb.client.state.ClientStateInterception;
import com.balancedbytes.games.ffb.client.state.ClientStateKickoff;
import com.balancedbytes.games.ffb.client.state.ClientStateKickoffReturn;
import com.balancedbytes.games.ffb.client.state.ClientStateLogin;
import com.balancedbytes.games.ffb.client.state.ClientStateMove;
import com.balancedbytes.games.ffb.client.state.ClientStatePass;
import com.balancedbytes.games.ffb.client.state.ClientStatePassBlock;
import com.balancedbytes.games.ffb.client.state.ClientStatePushback;
import com.balancedbytes.games.ffb.client.state.ClientStateQuickSnap;
import com.balancedbytes.games.ffb.client.state.ClientStateReplay;
import com.balancedbytes.games.ffb.client.state.ClientStateSelect;
import com.balancedbytes.games.ffb.client.state.ClientStateSetup;
import com.balancedbytes.games.ffb.client.state.ClientStateSpectate;
import com.balancedbytes.games.ffb.client.state.ClientStateStartGame;
import com.balancedbytes.games.ffb.client.state.ClientStateThrowTeamMate;
import com.balancedbytes.games.ffb.client.state.ClientStateTouchback;
import com.balancedbytes.games.ffb.client.state.ClientStateWaitForOpponent;
import com.balancedbytes.games.ffb.client.state.ClientStateWaitForSetup;
import com.balancedbytes.games.ffb.client.state.ClientStateWizard;
