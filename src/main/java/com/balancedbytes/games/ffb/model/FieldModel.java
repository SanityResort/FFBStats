...
implements IJsonSerializable {
    ...
    public JsonObject toJsonValue() {
        ...
        for (Player player : this.getGame().getPlayers()) {
            ...
            CardEffect[] arrcardEffect = this.getCardEffects(player);
            int n = arrcardEffect.length;
    ...
    public FieldModel initFrom(JsonValue pJsonValue) {
        ...
        for (int i = 0; i < pushbackSquareArray.size(); ++i) {
            this.fPushbackSquares.add(new PushbackSquare().initFrom(pushbackSquareArray.get(i)));
        }
        ...
        for (int i = 0; i < moveSquareArray.size(); ++i) {
            this.fMoveSquares.add(new MoveSquare().initFrom(moveSquareArray.get(i)));
        }
        ...
        for (int i = 0; i < trackNumberArray.size(); ++i) {
            this.fTrackNumbers.add(new TrackNumber().initFrom(trackNumberArray.get(i)));
        }
        ...
        for (int i = 0; i < diceDecorationArray.size(); ++i) {
            this.fDiceDecorations.add(new DiceDecoration().initFrom(diceDecorationArray.get(i)));
        }
        ...
        for (int i = 0; i < fieldMarkerArray.size(); ++i) {
            this.fFieldMarkers.add(new FieldMarker().initFrom(fieldMarkerArray.get(i)));
        }
        ...
        for (int i = 0; i < playerMarkerArray.size(); ++i) {
            this.fPlayerMarkers.add(new PlayerMarker().initFrom(playerMarkerArray.get(i)));
        }
