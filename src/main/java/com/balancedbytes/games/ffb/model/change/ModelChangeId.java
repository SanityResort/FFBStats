...
public enum ModelChangeId implements IEnumWithId,
IEnumWithName
{
    ...
    ACTING_PLAYER_SET_PLAYER_ACTION(11, "actingPlayerSetPlayerAction", ModelChangeDataType.PLAYER_ACTION),
    ...
    public JsonValue toJsonValue(Object pValue) {
        return this.getDataType().toJsonValue(pValue);
    }

    public Object fromJsonValue(JsonValue pJsonValue) {
        return this.getDataType().fromJsonValue(pJsonValue);
    }
}
