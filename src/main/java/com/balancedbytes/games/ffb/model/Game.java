...
implements IJsonSerializable {
    ...
    public void setTurnMode(TurnMode turnMode) {
        ...
        TurnMode lastTurnMode = this.fTurnMode;
        this.fTurnMode = turnMode;
        if (lastTurnMode != null && !lastTurnMode.isStoreLast()) {
            this.setLastTurnMode(lastTurnMode);
        }
    ...
    public void setLastTurnMode(TurnMode lastTurnMode) {
        if (lastTurnMode == this.fLastTurnMode) {
            return;
        }
        this.fLastTurnMode = lastTurnMode;
        this.notifyObservers(ModelChangeId.GAME_SET_LAST_TURN_MODE, null, this.fLastTurnMode);
    }
    ...
    public boolean isTurnTimeEnabled() {
        return this.getStarted() != null && this.getFinished() == null && (TurnMode.REGULAR == this.getTurnMode() || TurnMode.BLITZ == this.getTurnMode());
    }
    ...
    public void setAdminMode(boolean adminMode) {
        if (adminMode == this.fAdminMode) {
            return;
        }
        this.fAdminMode = adminMode;
        this.notifyObservers(ModelChangeId.GAME_SET_ADMIN_MODE, null, this.fAdminMode);
    }
    ...
    public Game transform() {
        ...
        transformedGame.setLastTurnMode(this.getLastTurnMode());
    ...
    public Game initFrom(JsonValue pJsonValue) {
        ...
        this.fLastTurnMode = (TurnMode)IJsonOption.LAST_TURN_MODE.getFrom(jsonObject);
