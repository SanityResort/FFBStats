...
public interface IJsonOption {
    ...
    public static final JsonEnumWithNameOption LAST_TURN_MODE = new JsonEnumWithNameOption("lastTurnMode", new TurnModeFactory());
    ...
    public static final JsonBooleanOption WIZARD_AVAILABLE = new JsonBooleanOption("wizardAvailable");
