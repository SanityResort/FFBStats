...
public class ServerCommandPasswordChallenge
extends ServerCommand {
    ...
    public JsonObject toJsonValue() {
        ...
        IJsonOption.CHALLENGE.addTo(jsonObject, this.fChallenge);
        return jsonObject;
    }
    ...
    public ServerCommandPasswordChallenge initFrom(JsonValue pJsonValue) {
        ...
        this.fChallenge = IJsonOption.CHALLENGE.getFrom(jsonObject);
        return this;
    }
}
