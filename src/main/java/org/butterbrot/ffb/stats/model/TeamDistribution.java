...
public class TeamDistribution {
    ...
    public TeamDistribution(TeamStatsCollection collection) {
        ...
        distributions.add(new Distribution("Successful Dodges", collection.getSuccessfulDodgeRolls(), Distribution.SKILL_ROLL_LABELS));
        distributions.add(new Distribution("Failed Dodges", collection.getFailedDodgeRolls(), Distribution.SKILL_ROLL_LABELS));
        distributions.add(new Distribution("Successful GFIs", collection.getSuccessfulGfiRolls(), Distribution.SKILL_ROLL_LABELS));
        distributions.add(new Distribution("Failed GFIs", collection.getFailedGfiRolls(), Distribution.SKILL_ROLL_LABELS));
        distributions.add(new Distribution("Successful D6s", collection.getSuccessfulSingleRolls(), Distribution.SKILL_ROLL_LABELS));
